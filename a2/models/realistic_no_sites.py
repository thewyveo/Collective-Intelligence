...
class PredatorPreyConfig(Config):
    ...
    predator_energy_consumption: float = 1.5
...
def run_simulation():
    ...
    # Save data to CSV
    df.to_csv('realistic2.csv', index=False)
    print("Data saved to realistic2.csv, plotting...")
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('realistic2.png')
    plt.close()

    print("Plotting complete. Plot saved to realistic2.png")
